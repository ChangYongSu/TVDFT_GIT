...
{
public:
	CShape(){} // COleDispatchDriver 기본 생성자를 호출합니다.
...
public:
	...
	void ScaleHeight(double Factor, long RelativeToOriginalSize, VARIANT& Scale)
	{
	...
	void ScaleWidth(double Factor, long RelativeToOriginalSize, VARIANT& Scale)
	{
		static BYTE parms[] = VTS_R4 VTS_I4 VTS_VARIANT ;
