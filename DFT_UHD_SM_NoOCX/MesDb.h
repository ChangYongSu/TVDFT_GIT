...
//	bool		GetSeqNo_Master_tb_Sql(CString strWipid, CString strDsn, CString strUserID, CString strPassWD, int& nSeqNo, CString &strRtn);
	...
	bool		GetOrgId_Master_tb_Sql(CString strModelSuffix,  long& nOrgId, CString &strRtn);
	bool		GetToolOption_Master_tb_Sql(CString strModelSuffix,  long nOrgId, CString &strRtn);
