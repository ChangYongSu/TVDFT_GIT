...
//	char	m_sReadBuffer[4096];	
	...
	CString MakeElem_S6F11_1(CString sEquipmentID, CString sPcbID, BOOL bModelSuffix);
	CString MakeElem_S6F11_2(CString sEquipmentID, CString sPcbID);
	CString MakeElem_S6F11_3(CString sEquipmentID, CString sPcbID);
