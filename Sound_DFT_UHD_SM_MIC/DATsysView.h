...
protected:
	...
	//CDC* m_pDC;          // Device Context for Picture Control
	//CStatic m_pictureCtrl; // Picture control
	//HGLRC m_hglrc2;       // OpenGL Rendering Context
	//CDC* m_pDC2;          // Device Context for Picture Control
	//CStatic m_pictureCtrl2; // Picture control

	//HGLRC m_hglrc1;        // Rendering context for the first picture control
	//HGLRC m_hglrc2;        // Rendering context for the second picture control
	//CDC* m_pDC1;           // Device context for the first picture control
	//CDC* m_pDC2;           // Device context for the second picture control
	//CStatic* m_pPicture1;  // Pointer to the first picture control
	//CStatic* m_pPicture2;  // Pointer to the second picture control

	//virtual void OnPaint();
//	afx_msg void OnSize(UINT nType, int cx, int cy);

	//void SetupOpenGLContext(CDC* pDC, HGLRC& hglrc);
	//void RenderScene1();
	//void RenderScene2();
...
////	CStatic m_pictureCtrl; // Picture control
	...
	//OpenGLControl m_openGL1;
	//OpenGLControl m_openGL2;
	//CStatic* m_pPicture1;
	//CStatic* m_pPicture2;
	//afx_msg void OnPaint();
	//DECLARE_MESSAGE_MAP()

	//CMyAppView() : m_hRC(NULL), m_hDC(NULL) {}
