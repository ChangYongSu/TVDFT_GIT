...
void COpenGLControl::DrawLeftScene()
{
...
void COpenGLControl::DrawRightScene()
{
...
#if 1
		m_PlotDataL[i].Data = sinf(PI * i * 0.01) / 2.;

#endif
		glVertex3f(i*0.002 - 1.0, m_PlotDataL[i].Data, 0.0f);
		glVertex3f((i + 1)*0.002 - 1.0, m_PlotDataL[i + 1].Data, 0.0f);
...
void  COpenGLControl::DrawPlot(int LR_Index)
{
	int iNum = 0;
	float fFont;
	int iWidth;
	...
	//		m_PlotDataL[i].Data = sinf(PI * i * 0.01) / 2.;
		...
		{
#if 1
//			m_PlotDataR[i].Data = sinf(PI * i * 0.01) / 2.;

#endif
			glVertex3f(i*0.002 - 1.0, m_PlotDataR[i].Data, 0.0f);
			glVertex3f((i + 1)*0.002 - 1.0, m_PlotDataR[i + 1].Data, 0.0f);
...
void  COpenGLControl::DrawBaseGround()
{
	...
	//	glRotatef(m_fRotZ, 0.0f, 0.0f, 1.0f);
		...
		//	glVertex3f(1.0f,-1.0f,0.0f);
			for(int i = 0 ; i < 7; i++)
			{
				glVertex3f(-1.0f,-1.0f+(2/6.0)*i,0.0f);		
				glVertex3f(1.0f,-1.0f+ (2 / 6.0)*i,0.0f);
			...
			for(int i = 0 ; i < 16; i++)
			{
				glVertex3f(-1.0f+ 2 / 15.*i,-1.0f,0.0f);
				glVertex3f(-1.0f+ 2 / 15.*i,1.0f,0.0f);
