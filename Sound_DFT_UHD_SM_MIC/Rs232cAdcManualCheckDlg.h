...
protected:
	...
	afx_msg void OnBtnLnbV();
	afx_msg void OnBtnLnbF();
	afx_msg void OnBtnSendCommand3();
	afx_msg void OnBtnKeydlCheck();
	//}}AFX_MSG
	DECLARE_MESSAGE_MAP()

public:
	CRichEditCtrl m_ctrlRs232cAdcComLog;

	afx_msg void OnBnClickedBtnSendCommand4();
	afx_msg void OnBnClickedBtnGrabStop();
	afx_msg void OnBnClickedBtnGrabStart();
};
