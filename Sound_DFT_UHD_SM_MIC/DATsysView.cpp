...
//void CDATsysView::InitOpenGL()
//{
//	// Get the device context from the picture control
//	m_pDC = m_pictureCtrl->GetDC();
//
//	if (!m_pDC)
//	{
...
//	if (!m_hglrc)
//	{
//		AfxMessageBox(_T("Failed to create OpenGL rendering context"));
//		return;
//	}
//
//	if (!wglMakeCurrent(m_pDC->GetSafeHdc(), m_hglrc))
//	{
//		AfxMessageBox(_T("Failed to make OpenGL rendering context current"));
//		return;
//	}
//
...
//
////void CDATsysView::SetupOpenGLContext(CDC* pDC, HGLRC& hglrc) {
////	PIXELFORMATDESCRIPTOR pfd;
...
////	SetPixelFormat(pDC->GetSafeHdc(), pixelFormat, &pfd);
////
...
//	CPaintDC dc(this);
//
//	//// Render first picture control
//	//wglMakeCurrent(m_pDC1->GetSafeHdc(), m_hglrc1);
//	//RenderScene1();
//	//SwapBuffers(m_pDC1->GetSafeHdc());
//
//	//// Render second picture control
//	//wglMakeCurrent(m_pDC2->GetSafeHdc(), m_hglrc2);
//	//RenderScene2();
...
//}
////
////void CDATsysView::OnSize(UINT nType, int cx, int cy)
////{
////	CFormView::OnSize(nType, cx, cy);
////	if (m_pPicture1 && m_pPicture2) {
////		CRect rect1, rect2;
////		m_pPicture1->GetWindowRect(&rect1);
////		m_pPicture2->GetWindowRect(&rect2);
////
////		ScreenToClient(&rect1);
////		ScreenToClient(&rect2);
////
////		m_openGL1.Resize(rect1.Width(), rect1.Height());
////		m_openGL2.Resize(rect2.Width(), rect2.Height());
////
////		m_openGL1.Render();
////		m_openGL2.Render();
////	}
...
//	m_LedsMesOn.SetTextBackground(1, RGB(238, 239, 231));
	...
	m_cRightLevelDisplay.SetTextColor(RGB(0, 255, 0));
		...
		//IDC_LEFT_FREQ_DISPLAY
		//IDC_LEFT_LEVEL_DISPLAY
		//IDC_RIGHT_FREQ_DISPLAY
		//IDC_RIGHT_LEVEL_DISPLAY
...
//	installhook(this->GetSafeHwnd());
	...
	CWnd* pWnd1 = GetDlgItem(IDC_STATIC_OGL_DISPLAY1);
...
///////////////////////////////////////////////
	...
	// Get a handle to the Picture Control
	CWnd* pWnd2 = GetDlgItem(IDC_STATIC_OGL_DISPLAY2);
...
//   // Initialize first picture control
//	m_pictureCtrl = NULL;
//	 // Link the CStatic control with the picture control
////	m_pictureCtrl.SubclassDlgItem(IDC_STATIC_OGL_DISPLAY, this);
//	m_pictureCtrl = (CStatic*)GetDlgItem(IDC_STATIC_OGL_DISPLAY);
//	m_pictureCtrl = (CStatic*)GetDlgItem(IDC_STATIC_OGL_DISPLAY2);
//
//	// Initialize OpenGL
//	InitOpenGL();
//
	  // Get the handles of the picture controls
	//m_pPicture1 = (CStatic*)GetDlgItem(IDC_STATIC_OGL_DISPLAY);
	//m_pPicture2 = (CStatic*)GetDlgItem(IDC_STATIC_OGL_DISPLAY2);

	//// Initialize OpenGL contexts for each control
	//m_openGL1.Initialize(m_pPicture1->GetSafeHwnd());
	//m_openGL2.Initialize(m_pPicture2->GetSafeHwnd());


	//m_pPicture1 = (CStatic*)GetDlgItem(IDC_STATIC_OGL_DISPLAY);
	//m_pDC1 = m_pPicture1->GetDC();
	//SetupOpenGLContext(m_pDC1, m_hglrc1);

	//// Initialize second picture control
	//m_pPicture2 = (CStatic*)GetDlgItem(IDC_STATIC_OGL_DISPLAY2);
	//m_pDC2 = m_pPicture2->GetDC();
	//SetupOpenGLContext(m_pDC2, m_hglrc2);
	...
	//GetDlgItem(IDC_STATIC_OGL_DISPLAY)->GetWindowRect(rect);
	//ScreenToClient(rect);
...
//	DWORD	dwStatus;
	...
	if (m_hGLRC1) wglDeleteContext(m_hGLRC1);
	if (m_hDC1) ::ReleaseDC(GetDlgItem(IDC_STATIC_OGL_DISPLAY1)->GetSafeHwnd(), m_hDC1);

	if (m_hGLRC2) wglDeleteContext(m_hGLRC2);
	if (m_hDC2) ::ReleaseDC(GetDlgItem(IDC_STATIC_OGL_DISPLAY2)->GetSafeHwnd(), m_hDC2);
	/*
	if (m_hglrc)
	{
		wglMakeCurrent(nullptr, nullptr);
	...
	if (m_pDC)
	{
		m_pictureCtrl->ReleaseDC(m_pDC);
		m_pDC = nullptr;
	}*/

	//if (m_hglrc1) {
	//	wglMakeCurrent(m_pDC1->GetSafeHdc(), NULL);
	//	wglDeleteContext(m_hglrc1);
	//	m_pDC1->DeleteDC();
	//}
	//if (m_hglrc2) {
	//	wglMakeCurrent(m_pDC2->GetSafeHdc(), NULL);
...
void CDATsysView::OnSize(UINT nType, int cx, int cy)
{
	...
	//	// Optionally, update the projection matrix
	//	glMatrixMode(GL_PROJECTION);
	//	glLoadIdentity();
	//	gluPerspective(45.0, (GLdouble)cx / (GLdouble)cy, 1.0, 1000.0);
...
LRESULT CDATsysView::OnUpdateSound(WPARAM wParam, LPARAM lParam)
{
	static int sWaitCount = 0;
	...
	//1000  2    2  2* 1000/m_Voltage_Left/500
	//2000      
	//3000  
	//5000  0.5  
