...
KEYDLL3_API void installhook1(HWND h);//This function installs the Keyboard hook.
KEYDLL3_API void removehook1();//This function removes the previously installed hook.
KEYDLL3_API LRESULT CALLBACK hookproc1(int ncode,WPARAM wparam,LPARAM lparam);//This function is called when the keyboard is operated.