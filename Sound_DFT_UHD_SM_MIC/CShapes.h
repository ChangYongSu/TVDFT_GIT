...
{
public:
	CShapes(){} // COleDispatchDriver 기본 생성자를 호출합니다.
...
public:
	...
	LPDISPATCH AddCallout(long Type, double Left, double Top, double Width, double Height)
	{
		LPDISPATCH result;
	...
	LPDISPATCH AddConnector(long Type, double BeginX, double BeginY, double EndX, double EndY)
	{
		LPDISPATCH result;
		static BYTE parms[] = VTS_I4 VTS_R4 VTS_R4 VTS_R4 VTS_R4 ;
	...
	LPDISPATCH AddLabel(long Orientation, double Left, double Top, double Width, double Height)
	{
		LPDISPATCH result;
		static BYTE parms[] = VTS_I4 VTS_R4 VTS_R4 VTS_R4 VTS_R4 ;
	...
	LPDISPATCH AddLine(double BeginX, double BeginY, double EndX, double EndY)
	{
		LPDISPATCH result;
	...
	LPDISPATCH AddPicture(LPCTSTR Filename, long LinkToFile, long SaveWithDocument, double Left, double Top, double Width, double Height)
	{
		LPDISPATCH result;
	...
	LPDISPATCH AddShape(long Type, double Left, double Top, double Width, double Height)
	{
		LPDISPATCH result;
		static BYTE parms[] = VTS_I4 VTS_R4 VTS_R4 VTS_R4 VTS_R4 ;
	...
	LPDISPATCH AddTextEffect(long PresetTextEffect, LPCTSTR Text, LPCTSTR FontName, double FontSize, long FontBold, long FontItalic, double Left, double Top)
	{
		LPDISPATCH result;
	...
	LPDISPATCH AddTextbox(long Orientation, double Left, double Top, double Width, double Height)
	{
		LPDISPATCH result;
		static BYTE parms[] = VTS_I4 VTS_R4 VTS_R4 VTS_R4 VTS_R4 ;
	...
	LPDISPATCH BuildFreeform(long EditingType, double X1, double Y1)
	{
		LPDISPATCH result;
	...
	LPDISPATCH AddDiagram(long Type, double Left, double Top, double Width, double Height)
	{
		LPDISPATCH result;
		static BYTE parms[] = VTS_I4 VTS_R4 VTS_R4 VTS_R4 VTS_R4 ;
	...
	LPDISPATCH AddCanvas(double Left, double Top, double Width, double Height)
	{
		LPDISPATCH result;
		static BYTE parms[] = VTS_R4 VTS_R4 VTS_R4 VTS_R4 ;
