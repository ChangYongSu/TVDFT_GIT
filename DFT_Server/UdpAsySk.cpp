...
//// CUdpAsySk
//
//CUdpAsySk::CUdpAsySk(CDialog* pDlg,int lIndex)
//{
//	m_pDlg = pDlg;
...
////	((CAcqVoltageSamples_IntClkDlg*)m_pDlg)->m_pUDPSocketServer[m_IndexID] = NULL;
//	
...
//				((CAcqVoltageSamples_IntClkDlg*)m_pDlg)->OnParseDataEthernet(0);
...
//}
//
//int CUdpAsySk::DoAsyncSendBuff(int lIndex)
//{
//	int lResult = 0;
//	 
...
//			dwBytes = SendTo((LPCTSTR)m_sendBuffer + m_nBytesSent, m_nBytesBufferSize - m_nBytesSent, 
//				g_nNetPortNumber[lIndex], (LPCTSTR)g_nRemoteIPAddress[lIndex]);
//		}
