...
//=========================
	...
	CString		sBoardOption;	
	CString		sCommercialBoardOption;
...
//	MODEL = 0, REMOCON, TESTED, STATUS, FAILED, TIME, RATE, MODE
	...
	COMMERCIAL_OPTION1, BOARD_OPTION, COMMERCIAL_BOARD_OPTION, CPU_VERSION, MICOM_VERSION, USB_VERSION, COUNTRAY_OPTION, COUNTRY_GROUP, COUNTRY,  MNT_VERSION, LED_STATE,
