#if !defined(AFX_VSFLEXGRID_H__F02D8BDE_6B3C_478E_81A1_17C9F1F70E0A__INCLUDED_)
#define AFX_VSFLEXGRID_H__F02D8BDE_6B3C_478E_81A1_17C9F1F70E0A__INCLUDED_
...
public:
	...
	void OLEDrag();
	void SaveGrid(LPCTSTR FileName, long SaveWhat, const VARIANT& Options);
	void LoadGrid(LPCTSTR FileName, long LoadWhat, const VARIANT& Options);
	...
	long GetShowComboButton();
	void SetShowComboButton(long nNewValue);
	LPDISPATCH GetCellButtonPicture();
	...
	LPDISPATCH GetNode(const VARIANT& Row);
	long GetColIndent(long Col);
	void SetColIndent(long Col, long nNewValue);
	void LoadGridURL(LPCTSTR URL, long LoadWhat, const VARIANT& Options);
	void FinishEditing(BOOL Cancel);
	CString GetAccessibleName();
	void SetAccessibleName(LPCTSTR lpszNewValue);
	CString GetAccessibleDescription();
	void SetAccessibleDescription(LPCTSTR lpszNewValue);
	CString GetAccessibleValue();
	void SetAccessibleValue(LPCTSTR lpszNewValue);
	VARIANT GetAccessibleRole();
	void SetAccessibleRole(const VARIANT& newValue);
	BOOL GetIsSearching();
};
...
#endif // !defined(AFX_VSFLEXGRID_H__F02D8BDE_6B3C_478E_81A1_17C9F1F70E0A__INCLUDED_)
