...
#define TOOLBAR_DRAW_BUTTON_WIDTH_3IN1 24
#define TOOLBAR_DRAW_BUTTON_WIDTH_2IN1 32
...
//	CFont m_fontTohama;
	...
	DECLARE_MESSAGE_MAP()
public:
	afx_msg void OnUpdateJigdownGood(CCmdUI *pCmdUI);
	afx_msg void OnUpdateJigdownAll(CCmdUI *pCmdUI);
	afx_msg void OnUpdateJigdownNot(CCmdUI *pCmdUI);
	afx_msg void OnUpdateAcpowerFail(CCmdUI *pCmdUI);
	afx_msg void OnUpdateAcpowerGood(CCmdUI *pCmdUI);
	afx_msg void OnUpdateAcpowerAll(CCmdUI *pCmdUI);
	afx_msg void OnUpdateAcpowerNot(CCmdUI *pCmdUI);
	afx_msg void OnUpdateAnalyseVf(CCmdUI *pCmdUI);
	...
	afx_msg void OnUpdateVfControl(CCmdUI *pCmdUI);
	afx_msg void OnUpdateOptionVfoption(CCmdUI *pCmdUI);
};
