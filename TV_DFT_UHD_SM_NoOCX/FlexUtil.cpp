// FlexUtil.cpp : VSFlexGrid Pro 8.0 utilities
//
...
BOOL SaveGridToHTML(CListCtrl* ctlList, LPSTR fname)
{
	...
	int  nWidth[13] = { 40, 100, 90,  70, 90, 75, 75, 65, 200, 200, 76, 500,10 }; //int  nWidth[13] = { 300,  400, 2400, 900, 700, 900, 750, 750, 650, 2000, 2000, 760, 5000};
...
BOOL SaveGridToText(CListCtrl* ctlList, LPSTR fname)
{
	...
	strTxt = "Y NO STEP    RESULT   MEAS    TARGET  L-LIMIT U-LIMIT UNIT    A/T(FREQ,LVL)   A/M(FREQ,LVL)   TIME    MESSAGE";
	strCell = strTxt + "\n";
	fprintf(f, "%s", strCell);
