...
//@CI111O11$  // Command PC=> SB
BOOL CScannerCtrl::SendOK()
{
	if(m_bPortOpen == TRUE)
	{
	SendCommString("@CI000O10$");
	return TRUE;
	}
	else
	{
...
BOOL CScannerCtrl::SendNG()
{
	if (m_bPortOpen == TRUE)
	{
		SendCommString("@CI000O01$");
		return TRUE;
	}
	else
	{
...
BOOL CScannerCtrl::SendClear()
{
	if (m_bPortOpen == TRUE)
	{
		SendCommString("@CI000O00$");
		return TRUE;
	}
	else
	{
